...
- **Notes:**
  ...
  - Kebijakan akses WhatsApp:
    ...
    - Hard block: jika pesan non-owner diawali `/` (slash command), wajib menolak langsung dengan jawaban singkat bahwa command internal tidak tersedia untuk non-owner
    - Override khusus: jika pesan dari non-owner berupa satu kata saja dan itu adalah command internal/slash command, wajib diam total (NO_REPLY), tanpa balasan penolakan.
 ...
 - Rule lintas channel RAG (permanent, owner request 2026-04-12):
  ...
  - Rule khusus grup Maslam Maestro (grup developer Maslam):
    - Update terbaru: termasuk pesan dari owner, SAMI hanya merespons jika ada mention eksplisit nama "SAMI" atau mention ke nomor/ID SAMI; selain itu NO_REPLY.
