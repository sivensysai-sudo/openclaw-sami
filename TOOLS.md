...
- 2026-04-10: To Be Masjid Visioner → `120363394811818734@g.us` (trigger: `#MAPGROUP SAMI`)
- 2026-04-10: MASLAM MADANI - LAMPUNG → `120363424006160635@g.us` (trigger: `#MAPGROUP SAMI`)
...
- 2026-04-10: MASLAM MADANI - BALI → `120363407451404336@g.us` (trigger: `#MAPGROUP SAMI`)
...
- 2026-04-10: MASLAM MADANI - PURWAKARTA → `120363424831141082@g.us` (trigger: `#MAPGROUP SAMI`)
...
- 2026-04-10: MASLAM MADANI - SUMATERA UTARA → `120363406261364099@g.us` (trigger: `#MAPGROUP SAMI`)
...
- 2026-04-10: Baitul Muamalah Powered By Maslam → `120363404376829424@g.us` (trigger: `#MAPGROUP SAMI`)
